...
def update_button_states(app_state, input_image_pil, queue_df_data):
    ...
    if is_editing:
        ...
        return (
            ...
            gr.update(interactive=False, variant="secondary"), # SAVE_QUEUE_BUTTON
            gr.update(interactive=False, variant="secondary"), # CLEAR_QUEUE_BUTTON
        )
    ...
    return (
        ...
        gr.update(interactive=image_actions_interactive, variant="secondary"),             # CLEAR_IMAGE_BUTTON
        gr.update(interactive=image_actions_interactive, variant="secondary"),             # DOWNLOAD_IMAGE_BUTTON
        gr.update(interactive=save_queue_interactive, variant=savueue_variant),         # SAVE_QUEUE_BUTTON
        gr.update(interactive=clear_pending_interactive, variant=cleae_qr_queue_variant),     # CLEAR_QUEUE_BUTTON
    )